//Exercicio 76: Escreva um algoritmo que leia certa quantidade de números e imprima o maior deles e quantas vezes
//o maior número foi lido. A quantidade de números a serem lidos deve ser fornecida pelo usuário. Assuma que o
//usuário sempre fornecerá um número positivo.

{         Solução em Portugol
Algoritmo Exercicio 76;
Var
